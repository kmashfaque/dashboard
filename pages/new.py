...
with col1:
    try:
        ...
        fig = px.bar(total_production_df, x="Product", y="Total Production",
                    template="seaborn", width=350,height=350,title="Total Production by Product",
...
with col2:
    try:
        ...
        # Update the layout
        fig.update_layout(xaxis_title="Product", yaxis_title="Total Production", barmode="stack")
