...
if data_files is not None:
    if st.button("Process"):
        ...
        for data_file in data_files:
            ...
            juteissue_entry_file=["Jute Issue Format_JJMLF.xlsm","Jute Issue Format_JJMLF.xlsm","Jute Issue Format_JJMLF.xlsm"]
            ...
            if data_file.name in stock_entry_file:
                ...
                try:
                    if data_file.type == 'application/vnd.ms-excel':
                            ...
                            df = pd.read_excel(data_file,sheet_name="Daily Update")
                            # st.write(df)
